// PipeClient2.cpp : Defines the entry point for the application.
//

#include "framework.h"
#include "PipeClient2.h"
#include <Windows.h>
#include <stdlib.h>
#include <stdio.h>
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_PIPECLIENT2, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_PIPECLIENT2));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_PIPECLIENT2));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_PIPECLIENT2);
    ...
    case WM_COMMAND:
        {
            ...
            case ID_PIPE_SENDMESSAGE:
                ...
                EnumWindows([](HWND hWnd, LPARAM lParam) -> BOOL {
                    ...
                    return TRUE;
                    }, reinterpret_cast<LPARAM>(&openedWindows));

                // ширина вікна додатку
                RECT rect;
                ...
                sprintf_s(mess, sizeof(mess), "Дані Клієнта #2:\r\n"
                    " - Кількість відкритих вікон: %d\r\n"
                    " - Ширина вікна додатку %d px\r\n"
                    " - DPI вертикально: %d\r\n",
                    openedWindows, windowWidth, verticalDPI
                );
